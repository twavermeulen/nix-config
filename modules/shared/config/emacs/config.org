...
#+BEGIN_SRC emacs-lisp
  (setq user-full-name "“thomas”"
    user-mail-address "“twa.vermeulen@student.avans.nl”")
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  ;; Set path for darwin
  (when (system-is-mac)
    (setenv "PATH" (concat (getenv "PATH") ":/Users/thomas/.nix-profile/bin:/usr/bin"))
    (setq exec-path (append '("/Users/thomas/bin" "/profile/bin" "/Users/thomas/.npm-packages/bin" "/Users/thomas/.nix-profile/bin" "/nix/var/nix/profiles/default/bin" "/usr/local/bin" "/usr/bin") exec-path)))
#+END_SRC
